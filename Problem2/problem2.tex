...
\section*{2.2}
\subsection*{a)}
Find the Hermitian conugate of the following operators $i$, $x²$ and $\frac{d}{dx}$. Given an operator $\hat{O}$, its Hermitian conjugate $\hat{O}^{\dagger}$ satisfies the following property by definition.
\begin{equation}
